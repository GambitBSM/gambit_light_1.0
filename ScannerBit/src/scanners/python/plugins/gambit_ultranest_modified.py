...
class ReactiveUltranestModified(splug.scanner):
    """
...
pkl_name ('ultranest.pkl'):  File name where results will be pickled
    ...
    def __init__(self, pkl_name='ultranest.pkl', log_dir="ultranest", **kwargs):
        ...
        # Set the sampler to use a step sampler algorithm
        nsteps = int(0.25 * self.dim)
        generate_direction = ultranest.stepsampler.generate_mixture_random_direction
        self.sampler.stepsampler = ultranest.stepsampler.SliceSampler(nsteps, generate_direction)
...
__plugins__ = {"reactive_ultranest_modified": ReactiveUltranestModified}
